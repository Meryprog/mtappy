                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                        <Dropdown
                            ...
                            <Link href="/dashboard">
                                <DropdownButton href="/dashboard">
                                    <i className="bi bi-grid mr-3"></i>
                                    <span>Dashboard</span>
                                </DropdownButton>
                            </Link>
                            <Link href="/valider">
                                <DropdownButton href="/update-dette">
                                    <i className="bi bi-card-list mr-3"></i>
                                    <span>Valider des demandes</span>
                                </DropdownButton>
                            </Link>
                            <Link href="/update-dette">
                                <DropdownButton>
                                    <i className="bi bi-pencil-square mr-3"></i>
                                    <span>Mettre à jour dette</span>
                                </DropdownButton>
                            </Link>
                            <Link href="/listeclient">
                                <DropdownButton>
