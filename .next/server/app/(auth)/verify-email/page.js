...
/* harmony export */ });
/* harmony import */ var _mnt_metrodeploy_client_src_app_auth_verify_email_page_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(40435);
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 40435)), "/mnt/metrodeploy/client/src/app/(auth)/verify-email/page.js"],
...
const pages = ["/mnt/metrodeploy/client/src/app/(auth)/verify-email/page.js"];


const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(auth)/verify-email/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 92989));
...
/* harmony import */ var _hooks_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9546);
...
const Page = ()=>{
    const { logout, resendEmailVerification } = (0,_hooks_auth__WEBPACK_IMPORTED_MODULE_2__/* .useAuth */ .a)({
        middleware: "auth",
        redirectIfAuthenticated: "/dashboard"
    });
    const [status, setStatus] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(null);
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            status === "verification-link-sent" && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(auth)/verify-email/page.js`)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(auth)/verify-email/page.js#default`));
...
var __webpack_exports__ = __webpack_require__.X(0, [948,495,99,35,781], () => (__webpack_exec__(58266)));
