...
/* harmony export */ });
/* harmony import */ var _mnt_metrodeploy_client_src_app_auth_admin_register_page_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(81658);
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 81658)), "/mnt/metrodeploy/client/src/app/(auth)/admin/register/page.js"],
...
const pages = ["/mnt/metrodeploy/client/src/app/(auth)/admin/register/page.js"];


const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(auth)/admin/register/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 61916));
...
const Page = ()=>{
    const { register } = (0,_hooks_auth__WEBPACK_IMPORTED_MODULE_7__/* .useAuth */ .a)({
        middleware: "guest",
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(auth)/admin/register/page.js`)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(auth)/admin/register/page.js#default`));
...
var __webpack_exports__ = __webpack_require__.X(0, [948,495,99,35,781], () => (__webpack_exec__(98336)));
