...
/* harmony export */ });
/* harmony import */ var _mnt_metrodeploy_client_src_app_app_listeclient_page_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47836);
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47836)), "/mnt/metrodeploy/client/src/app/(app)/listeclient/page.js"],
...
const pages = ["/mnt/metrodeploy/client/src/app/(app)/listeclient/page.js"];


const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(app)/listeclient/page";
const __next_app__ = {
...
const routeModule = new next_dist_server_future_route_modules_app_page_module_compiled__WEBPACK_IMPORTED_MODULE_5__.AppPageRouteModule({
    definition: {
        ...
        page: "/(app)/listeclient/page",
        pathname: "/listeclient",
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 47503));
...
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(35047);
/* harmony import */ var _lib_axios__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(80235);
...
const Dashboard = ()=>{
    const [clientsValides, setClientsValides] = (0,react__WEBPACK_IMPORTED_MODULE_13__.useState)([]);
    const [clientsInvalides, setClientsInvalides] = (0,react__WEBPACK_IMPORTED_MODULE_13__.useState)([]);
    const router = (0,next_navigation__WEBPACK_IMPORTED_MODULE_14__.useRouter)();
    (0,react__WEBPACK_IMPORTED_MODULE_13__.useEffect)(()=>{
        // Fetch valid clients
        _lib_axios__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z.get("/api/clients/valides").then((response)=>{
            setClientsValides(response.data);
            jquery__WEBPACK_IMPORTED_MODULE_11___default()(".datatable-valides").DataTable();
        }).catch((error)=>{
            console.error("Erreur lors de la r\xe9cup\xe9ration des clients valides:", error);
        });
        // Fetch invalid clients
        _lib_axios__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z.get("/api/clients/invalides").then((response)=>{
            setClientsInvalides(response.data);
            jquery__WEBPACK_IMPORTED_MODULE_11___default()(".datatable-invalides").DataTable();
        }).catch((error)=>{
            console.error("Erreur lors de la r\xe9cup\xe9ration des clients invalides:", error);
        });
    }, []);
    const handleActivation = async (event, clientId)=>{
        event.preventDefault();
        try {
            const response = await _lib_axios__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z.post(`/api/clients/${clientId}/activer`);
            if (response.data.message) {
                alert("Client activ\xe9 avec succ\xe8s");
                                    ...
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h5", {
                                                ...
                                                children: "Liste des clients valides"
                                            }),
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                                className: "table datatable-valides",
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                                                        children: clientsValides.map((client)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                ...
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                    ...
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h5", {
                                                className: "card-title",
                                                children: "Liste des clients non valides"
                                            }),
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("table", {
                                                className: "table datatable-invalides",
                                                children: [
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("thead", {
                                                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                            children: [
                                                    ...
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("tbody", {
                                                        children: clientsInvalides.map((client)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("tr", {
                                                                children: [
                                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("th", {
                                                                        scope: "row",
                                                                        children: client.id
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(app)/listeclient/page.js`)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(app)/listeclient/page.js#default`));
...
var __webpack_exports__ = __webpack_require__.X(0, [948,495,99,35,245,233,781,555], () => (__webpack_exec__(31961)));
