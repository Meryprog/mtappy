...
/* harmony export */ });
/* harmony import */ var _mnt_metrodeploy_client_src_app_client_profil_page_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21686);
...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 21686)), "/mnt/metrodeploy/client/src/app/(client)/profil/page.js"],
...
const pages = ["/mnt/metrodeploy/client/src/app/(client)/profil/page.js"];


const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(client)/profil/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 21711));
...
/* harmony import */ var _barrel_optimize_names_FaArrowLeft_FaEdit_FaEnvelope_FaPhone_FaUser_react_icons_fa__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(90622);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(35047);
/* harmony import */ var swr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4040);
...
/* __next_internal_client_entry_do_not_use__ default auto */ 
 ...
 // Importer le hook d'authentification

const Profile = ()=>{
    const router = (0,next_navigation__WEBPACK_IMPORTED_MODULE_2__.useRouter)();
    const { logout } = (0,_hooks_auth__WEBPACK_IMPORTED_MODULE_5__/* .useAuth */ .a)(); // Utiliser la fonction de déconnexion
    ...
    const [isEditing, setIsEditing] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
        name: false,
        email: false,
        phone: false,
        address: false
    ...
    const fetcher = (url)=>_lib_axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.get(url).then((res)=>res.data);
    const { data, mutate } = (0,swr__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .ZP)("/api/client-profile", fetcher);
    ...
    const handleSubmit = async (field)=>{
        try {
            await _lib_axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.post("/api/update-client-profile", userData);
            toggleEdit(field);
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("header", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_barrel_optimize_names_FaArrowLeft_FaEdit_FaEnvelope_FaPhone_FaUser_react_icons_fa__WEBPACK_IMPORTED_MODULE_7__/* .FaArrowLeft */ .x_l, {
                            className: "text-xl",
                            onClick: ()=>router.back()
                        })
                    }),
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_barrel_optimize_names_FaArrowLeft_FaEdit_FaEnvelope_FaPhone_FaUser_react_icons_fa__WEBPACK_IMPORTED_MODULE_7__/* .FaEdit */ .fmQ, {
                            className: "text-xl"
                        })
                    })
                ]
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: "w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center text-4xl text-red-700",
                            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_barrel_optimize_names_FaArrowLeft_FaEdit_FaEnvelope_FaPhone_FaUser_react_icons_fa__WEBPACK_IMPORTED_MODULE_7__/* .FaUser */ .Xws, {})
                        })
                    }),
                    [
                        "name",
                        ...
                        "tel",
                        "address"
                    ].map((field)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: "mb-4",
                            children: [
                                ...
                                isEditing[field] ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("input", {
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(client)/profil/page.js`)
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/mnt/metrodeploy/client/src/app/(client)/profil/page.js#default`));
...
var __webpack_exports__ = __webpack_require__.X(0, [948,495,99,35,622,781], () => (__webpack_exec__(99858)));
